...
void main() {
  int?
      score; // Create a nullable integer variable score but do not assign it a value.

  print(score ??
      'No score'); // Print score if it has a value, otherwise print 'No score'.

  // Try assigning a value to score and run the code again to see the change.
  score = 85;
  print(score ??
      'No score'); // We now see the score displayed instead of "No score"
}
